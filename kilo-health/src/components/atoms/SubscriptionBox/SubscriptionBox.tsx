...
const SubscriptionBox = () => {
  ...
  return (
      <div onClick={()=>setSelected(!selected)} className="subscription-box" style={selected ? {border:"2px solid #ff9b4e" }: {border:"2px solid rgba(0, 0, 0, 0.08)" } }>
            ...
            <div className="subscription-box--main">
                ...
                <div className="tickbox">
                    {selected? <img src={TickBox} alt="tickbox" /> : <img src={TickBoxGray} alt="tickbox" /> }
                </div>
            </div>
